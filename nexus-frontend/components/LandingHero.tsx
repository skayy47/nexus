...
const FEATURE_META = [
  { icon: Zap, color: '#fb7185', bg: 'rgba(251,113,133,0.1)' },
  { icon: Search, color: '#fbbf24', bg: 'rgba(251,191,36,0.1)' },
  { icon: FileText, color: '#818cf8', bg: 'rgba(99,102,241,0.1)' },
  { icon: ShieldCheck, color: '#34d399', bg: 'rgba(52,211,153,0.1)' },
]
      ...
      <div className="bg-[#06070d] text-slate-100 relative">
        ...
        <header className="fixed top-0 inset-x-0 z-50 flex items-center justify-between px-6 py-4 bg-[#06070d]/55 backdrop-blur-md border-b border-white/5">
          ...
          <nav className="flex items-center gap-7">
            <a href="#pipeline" className="hidden sm:block text-sm text-slate-400 hover:text-slate-100 transition-colors">{t('nav.howItWorks')}</a>
            <a href="#features" className="hidden sm:block text-sm text-slate-400 hover:text-slate-100 transition-colors">{t('nav.features')}</a>
            <a href="#proof" className="hidden sm:block text-sm text-slate-400 hover:text-slate-100 transition-colors">{t('nav.liveDemo')}</a>
            <LanguageSwitcher />
                ...
                return (
                  <motion.div key={n} variants={fadeUp} initial="hidden" whileInView="show"
                    ...
                    <div className="flex-1 rounded-[18px] p-5 bg-[rgba(18,20,34,0.6)] border border-[rgba(99,102,241,0.16)] backdrop-blur-md hover:border-[rgba(99,102,241,0.45)] hover:translate-x-1 transition-all">
                      ...
                      <p className="text-slate-400 text-[14.5px] leading-relaxed">{tx(`pipeline.step${n}Desc`)}</p>
                      <span className="inline-block mt-3 text-[11.5px] text-indigo-300 bg-indigo-500/10 border border-[rgba(99,102,241,0.16)] px-2.5 py-1 rounded-lg">{tx(`pipeline.step${n}Tag`)}</span>
                    </div>
                  </motion.div>
                )
              })}
    ...
    <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true, margin: '-40px' }}
      ...
      <div className="p-6">
        ...
        <div className="bg-white/[0.03] border border-[rgba(99,102,241,0.16)] rounded-[4px_14px_14px_14px] p-[18px] text-[14.5px] text-slate-100 leading-relaxed">
          ...
          <span className="text-indigo-300 text-[12.5px]">[TechCorp_HR_Policy_2024 · p.1]</span>{t('answerMid')}
          <b>{t('answer3days')}</b> <span className="text-indigo-300 text-[12.5px]">[TechCorp_HR_Policy_2023 · p.1]</span>{t('answerPost')}

          <div className="mt-[18px]">
            <div className="flex justify-between text-xs text-slate-400 mb-1.5"><span>{t('groundingLabel')}</span><span className="text-amber-400">{t('groundingValue')}</span></div>
          ...
          <div className="mt-4 flex gap-3 bg-[rgba(251,113,133,0.07)] border border-[rgba(251,113,133,0.25)] rounded-xl p-[13px_15px]" style={{ padding: '13px 15px' }}>
            ...
            <div className="flex-1">
              ...
              <p className="text-[13px] text-slate-400">{t('contradictionDesc')}</p>
              <div className="flex flex-col sm:flex-row gap-2.5 mt-2.5 text-xs">
                <div className="flex-1 bg-white/[0.03] border border-white/[0.07] rounded-lg p-2.5">
                  <div className="text-slate-500 text-[10.5px] mb-1">TechCorp_HR_Policy_2023</div>{t('policy2023Limit')}</div>
                <div className="flex-1 bg-white/[0.03] border border-white/[0.07] rounded-lg p-2.5">
                  <div className="text-slate-500 text-[10.5px] mb-1">TechCorp_HR_Policy_2024</div>{t('policy2024Limit')}</div>
              </div>
            </div>
          </div>
        </div>
